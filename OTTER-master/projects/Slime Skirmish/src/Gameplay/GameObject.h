...
// Predeclaration for Scene
	...
	public:
		...
		/// <summary>
		/// Sets the game object's health
		/// </summary>
		/// <param name="value">The new health for the object</param>
		...
		/// <summary>
		/// Sets the game object's size amount
		/// </summary>
		/// <param name="value">The new size for the object</param>
		void SetSize(float value);
		/// <summary>
		/// Gets the object's size amount
		/// </summary>
		float GetSize() const;
