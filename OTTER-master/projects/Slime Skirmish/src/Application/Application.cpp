...
// Layers
#include "Layers/MainSceneLayer.h"
#include "Layers/MenuSceneLayer.h"
#include "Layers/EndSceneLayer.h"
...
std::string Application::_applicationName = "Slime Skirmish";
...
void Application::_Run()
{
	...
	_layers.push_back(std::make_shared<EndSceneLayer>());
	_layers.push_back(std::make_shared<MainSceneLayer>());
...
void Application::_RegisterClasses()
{
	...
	// Register all of our custom component types so we can load them from files
	...
	ComponentManager::RegisterType<ArrivalBehaviour>();
	ComponentManager::RegisterType<MorphTarget>();
	ComponentManager::RegisterType<TopDownCamera>();
	ComponentManager::RegisterType<ScoreKeep>();
	ComponentManager::RegisterType<PauseComponent>();
	ComponentManager::RegisterType<FMODStudio>();
	ComponentManager::RegisterType<SuperEnemyComponent>();
}
